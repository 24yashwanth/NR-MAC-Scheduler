 ...
 * assigment (MyTdma::BeforeDlSched and
 * MyTdma::BeforeUlSched) as well as what to do after
 ...
 */
class MyTdma : public NrMacSchedulerNs3
{
public:
  /**
   * \brief GetTypeId
  ...
  /**
   * \brief MyTdma constructor
   */
  MyTdma ();
  /**
   * \brief MyTdma deconstructor
   */
  virtual ~MyTdma () override;
